        ...
        <?php if (!isset($_POST['btn'])){ ?>
            ...
            <form class="" method="POST">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="Debit/Credit Card" checked>
                    <label class="form-check-label" for="exampleRadios1">Debit/Credit Card</label>
                </div>
            ...
            <?php
                ...
                if ($method == 'Debit/Credit Card'){
                    ...
                    <form class="" action="completePayment.php" method="post">
                        ...
                        <script scr="../controller/pay.js"></script>
